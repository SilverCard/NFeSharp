...
namespace NFeSharp.Esquemas.v3_10
{
    ...
    public class TIpi
    {
        ...
        [XmlElement("IPINT", typeof(TIpiIPINT))]
        [XmlElement("IPITrib", typeof(TIpiIPITrib))]
        public object Item { get; set; }
    }
    ...
    public class TNFeInfNFeDest
    {
        ...
        [XmlElement("CNPJ", typeof(string))]
        [XmlElement("CPF", typeof(string))]
        [XmlElement("idEstrangeiro", typeof(string))]
        [XmlChoiceIdentifierAttribute("ItemElementName")]
        public string Item { get; set; }
    ...
    public class TNFeInfNFeDetProd
    {
        ...
        [XmlElement("nRECOPI", typeof(string))]
    ...
    [XmlTypeAttribute(AnonymousType = true, Namespace = Namespaces.NFe)]
    public class TNFeInfNFeDetProdDetExport
    {
    ...
    [XmlTypeAttribute(AnonymousType = true, Namespace = Namespaces.NFe)]
    public class TNFeInfNFeDetProdDetExportExportInd
    {
    ...
    [XmlTypeAttribute(AnonymousType = true, Namespace = Namespaces.NFe)]
    public class TNFeInfNFeDetImpostoDevol
    {
    ...
    [XmlTypeAttribute(AnonymousType = true, Namespace = Namespaces.NFe)]
    public class TNFeInfNFeDetImpostoDevolIPI
    {
    ...
    [XmlTypeAttribute(AnonymousType = true, Namespace = Namespaces.NFe)]
    public class TNFeInfNFePagCard
    {
